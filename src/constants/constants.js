export const projects = [
  ...
  {
    title: 'FlatMate',
    description: "This website helps in renting rooms etc. Special feature of this website is that you can also find a room-mate, with whom you can share the room expense. Used css, javascript, php for creating this website.",
      image: '/images/i3.png',
  ...
  {
    title: 'GSOC Tagger',
    description: "Created this blog page which give information regarding GSOC. It tells the importance of GSOC, steps to apply, some insights from its qualifiers. Used normal HTML, CSS, JavaSrcipt for this page.",
    image: '/images/i4.png',
